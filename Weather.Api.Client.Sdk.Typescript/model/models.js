...
__exportStar(require("./weatherForecastDto"), exports);
const httpValidationProblemDetails_1 = require("./httpValidationProblemDetails");
const loginCredentials_1 = require("./loginCredentials");
const problemDetails_1 = require("./problemDetails");
const token_1 = require("./token");
const weatherForecastDto_1 = require("./weatherForecastDto");
...
let enumsMap = {};
let typeMap = {
    "HttpValidationProblemDetails": httpValidationProblemDetails_1.HttpValidationProblemDetails,
    "LoginCredentials": loginCredentials_1.LoginCredentials,
    "ProblemDetails": problemDetails_1.ProblemDetails,
    "Token": token_1.Token,
    "WeatherForecastDto": weatherForecastDto_1.WeatherForecastDto,
};
