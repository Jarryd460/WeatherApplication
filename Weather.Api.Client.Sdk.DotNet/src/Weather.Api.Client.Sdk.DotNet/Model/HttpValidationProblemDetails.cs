...
namespace Weather.Api.Client.Sdk.DotNet.Model
{
    ...
    public partial class HttpValidationProblemDetails : Dictionary<String, Object>, IEquatable<HttpValidationProblemDetails>, IValidatableObject
    {
        ...
        public HttpValidationProblemDetails(Dictionary<string, List<string>> errors = default(Dictionary<string, List<string>>), string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string)) : base()
        {
            this.Errors = errors;
            this.Type = type;
            this.Title = title;
