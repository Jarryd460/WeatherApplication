...
namespace Weather.Api.Client.Sdk.DotNet.Model
{
    ...
    public partial class ValidationProblemDetails : Dictionary<String, Object>, IEquatable<ValidationProblemDetails>, IValidatableObject
    {
        ...
        public ValidationProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), Dictionary<string, List<string>> errors = default(Dictionary<string, List<string>>)) : base()
        {
            this.Type = type;
            this.Title = title;
            this.Status = status;
